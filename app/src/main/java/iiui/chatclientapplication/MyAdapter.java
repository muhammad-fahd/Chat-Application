...
/**
 * Created by muhammad adeel on 18-Mar-18.
 */
...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (messages.get(position).fromMe()) {
            ...
            TextView myMsgTextView = messageView.findViewById(R.id.mymessageTextView);
            TextView myTimeTextView = messageView.findViewById(R.id.mytimeTextView);

            myTimeTextView.setText(messages.get(position).getTime());
            myMsgTextView.setText(messages.get(position).getMessage());
            ...
            TextView msgTextView   = messageView.findViewById(R.id.messageTextView);

            timeTextView.setText(messages.get(position).getTime());
            msgTextView.setText(messages.get(position).getMessage());
        }
